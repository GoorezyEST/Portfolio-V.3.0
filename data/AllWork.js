    ...
    projects: [
      {
        ...
        extra_data: {
          es: [
            ...
            {
              side: "left",
              img: "https://i.imgur.com/TrhcEG6.png",
            ...
            {
              side: "right",
              img: "https://i.imgur.com/8qVVgYf.png",
            ...
            {
              side: "left",
              img: "https://i.imgur.com/3Anfk3W.png",
            ...
            {
              side: "right",
              img: "https://i.imgur.com/5GJuRxq.png",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        second_text_en:
          "You can also sort these repositories by oldest, most recent, most stars or least stars. And you will also be able to see the total of their followers, followed and repositories.",
        first_text_es:
          "Utilizando la API de GitHub, Get Repos te permite ver todos los repositorios públicos de un usuario simplemente escribiendo su nombre.",
        second_text_es:
      ...
      },
      {
        ...
        first_text_en:
          "A single page web application to see the most popular cryptocurrencies, as well as to preview their values ​​when converting them to other cryptocurrencies.",
        second_text_en:
        ...
        first_text_es:
          "Una aplicación web de una sola página para ver las criptomonedas más populares, así como para previsualizar sus valores al convertirlas a otras criptomonedas.",
        second_text_es:
      ...
      },
      {
        title: "E-Booking",
        first_text_en:
          "An electronic booking website where you can see a range of products, add the ones you want to the cart and after completing a form receive a verification email.",
        second_text_en:
        ...
        first_text_es:
          "Un sitio web de reservas electrónicas en el que puede ver una gama de productos, añadir los que desee al carrito y, tras rellenar un formulario, recibir un correo electrónico de verificación.",
        second_text_es:
      ...
      },
      {
        title: "Portfolio - V.2",
        first_text_en:
          "I focused on achieving a simple but elegant aesthetic throughout the page, also adding an option at the top to change between light and dark colors.",
        second_text_en:
          "Also look to create dynamism through GSAP and Framer Motion to increase user retention and experience.",
        first_text_es:
          "Me centré en conseguir una estética sencilla pero elegante en toda la página, añadiendo también una opción en la parte superior para cambiar entre colores claros y oscuros.",
        second_text_es:
          "También busque crear dinamismo a través de GSAP y Framer Motion para aumentar la retención y experiencia del usuario.",
      ...
      },
      {
        title: "Mate y código",
        first_text_en:
          "I decided to recreate my previous blog to give it a more professional look and improve user interactivity.",
        second_text_en:
        ...
        first_text_es:
          "Decidí recrear mi anterior blog para darle un aspecto más profesional y mejorar la interactividad con el usuario.",
        second_text_es:
      ...
      },
      {
        title: "Geek Genius",
        first_text_en:
          "This Discord bot allows users to play trivia on its servers. Users can answer questions of different categories and difficulties, and the bot adds or subtracts points depending on whether they answer correctly or not.",
        second_text_en:
          "In addition, the bot includes a Top 10 feature that allows users to compete to see who can score the most points on each server.",
        first_text_es:
          "Este bot de Discord permite a los usuarios jugar trivia en sus servidores. Los usuarios pueden responder preguntas de diferentes categorías y dificultades, y el bot suma o resta puntos según si responden correctamente o no.",
        second_text_es:
          "Además, el bot incluye una función de Top 10 que permite a los usuarios competir para ver quién puede conseguir más puntos en cada servidor.",
        image_url: "https://i.imgur.com/vyURyFn.png",
        proyect_url:
      ...
      },
      {
        title: "EncryptoNET",
        first_text_en:
          "A .NET MAUI application, which is a cross-platform framework for creating native desktop and mobile applications with C# and XAML.",
        second_text_en:
          "It allows the user to encrypt and decrypt text in MD5 and Base64 format quickly and easily.",
        first_text_es:
          "Una aplicación de .NET MAUI, el cual es un marco multiplataforma para crear aplicaciones móviles y de escritorio nativas con C# y XAML.",
        second_text_es:
          "Esta permite al usuario encriptar y desencriptar texto en formato MD5 y Base64 rápido y sencillo.",
        image_url: "https://i.imgur.com/wCrx2sV.png",
        proyect_url:
      ...
      },
      {
        title: "Skyring",
        first_text_en:
          "Skyring was a project developed to imitate the chat functionality of Hattyng, whose database was deactivated for a while.",
        second_text_en:
        ...
        first_text_es:
          "Skyring fue un proyecto desarrollado para imitar la funcionalidad de chat de Hattyng, cuya base de datos estuvo desactivada durante un tiempo.",
        second_text_es:
      ...
      },
      {
        title: "WareStore",
        first_text_en:
          "Before diving into .NET MAUI, I decided to take a look at Windows Forms to familiarize myself with desktop applications. And then I decided to create an application to manage an imaginary computer business.",
        second_text_en:
          "The application offers a wide variety of features, including an inventory, charts, the ability to print/save tickets, among others.",
        first_text_es:
          "Antes de sumergirme en .NET MAUI, decidí echar un vistazo a Windows Forms para familiarizarme con las aplicaciones de escritorio. Y entonces decidi crear una aplicación que permita administrar un negocio de informática imaginario.",
        second_text_es:
          "La aplicación ofrece una amplia variedad de características, incluyendo un inventario, gráficos, la capacidad de imprimir/guardar boletas, entre otros.",
        image_url: "https://i.imgur.com/vr1L8Id.png",
        proyect_url:
      ...
      },
      {
        title: "Hawk Clothes",
        first_text_en:
          "In this project I decided to create a website for an imaginary e-commerce called Hawk Clothes.",
        second_text_en:
          "Using Figma and a website that generated clothing mockups, I designed a logo and added it to the clothing items seen on the website. The clothes can also be seen in different colors.",
        first_text_es:
          "En este proyecto decidí crear un sitio web para un comercio electrónico imaginario llamado Hawk Clothes.",
        second_text_es:
          "Utilizando Figma y un sitio web que genera maquetas de ropa, diseñé un logotipo y lo añadí a las prendas que se ven en el sitio web. La ropa también puede verse en distintos colores.",
        ...
        extra_data: {
          es: [
            {
              banner: "https://i.imgur.com/n9KpH1H.png",
              title: "HAWK CLOTHES",
            },
            {
              side: "left",
              img: "https://i.imgur.com/w3WkcUp.png",
              title: "SOBRE EL PROYECTO",
              text: "En este proyecto decidí crear un sitio web para un comercio electrónico imaginario llamado Hawk Clothes.\nUtilizando Figma y un sitio web que genera maquetas de ropa, diseñé un logotipo y lo añadí a las prendas que se ven en el sitio web. La ropa también puede verse en distintos colores.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/6PFiMQX.png",
              title: "LOS PRODUCTOS",
              text: "En la imagen se pueden ver los productos del sitio web, en los que el usuario puede hacer clic para ser redirigido a una página individual del producto en cuestión para ver su información en detalle.\nCada producto tiene un sencillo efecto hover que hace descender del eje Y una superposición oscura con un filtro de desenfoque y un texto que dice 'ver más'.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/xpjnYMk.png",
              title: "PRODUCTO INDIVIDUAL",
              text: "En esta página el usuario puede ver el precio del producto en cuestión, así como cambiar los colores del producto. Dependiendo del producto, existen distintas variaciones de color.\nSi el usuario hace clic en 'Me interesa', se mostrará una ventana modal indicando que la tienda existe en un lugar imaginario.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/6oJIlu7.png",
              title: "FAQs",
              text: "También aproveché que estaba haciendo este proyecto para hacer una sección de FAQs (preguntas más frecuentes).\nCon una sutil animación al hacer clic con la que se abren y la flecha gira en dirección contraria a la que estás mirando.",
            },
            {
              project: "https://hawk-clothes.netlify.app/home",
            },
          ],
          en: [
            {
            ...
            },
            {
              ...
              text: "In this project I decided to create a website for an imaginary e-commerce called Hawk Clothes.\nUsing Figma and a website that generated clothing mockups, I designed a logo and added it to the clothing items seen on the website. The clothes can also be seen in different colors.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/6PFiMQX.png",
              title: "THE PRODUCTS",
              text: "In the image you can see the products of the web site, in which the user can click to be redirected to an individual page of the product in question to see its information in detail.\nEach product has a simple hover effect that brings down from the Y axis a dark overlay with a blur filter and a text that says 'see more'.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/xpjnYMk.png",
              title: "INDIVIDUAL PRODUCT",
              text: "On this page the user can see the price of the product in question, as well as change the colors of the product. Depending on the product there are different color variations.\nIf the user clicks on 'I'm interested' a modal window will be shown indicating that the store exists in an imaginary place.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/6oJIlu7.png",
              title: "FAQS",
              text: "I also took advantage of the situation when doing this project to make a FAQs (Frequently asked questions) section.\nWith a subtle on click animation with which they open and the arrow turns in the opposite direction to the one you are looking at.",
            },
            {
              project: "https://hawk-clothes.netlify.app/home",
            },
      ...
      },
      {
        title: "Portfolio - V.1",
        first_text_en:
          "Developed in React.js this was my first portfolio where the user could read about me, get in touch, and also see my projects in a slider.",
        second_text_en:
          "I tried to achieve a serious and formal aesthetic, as well as this was the first time I used Figma to do a general design of the website before starting to code it.",
        first_text_es:
          "Desarrollado en React.js este fue mi primer portafolio donde el usuario podía leer sobre mí, ponerse en contacto, y también ver mis proyectos en un slider.",
        second_text_es:
          "Intenté conseguir una estética seria y formal, además de que era la primera vez que utilizaba Figma para hacer un diseño general del sitio web antes de empezar a codificarlo.",
        ...
        extra_data: {
          es: [
            {
              banner: "https://i.imgur.com/KmtewUA.png",
              title: "PORTFOLIO - V.1",
            },
            {
              side: "left",
              img: "https://i.imgur.com/Wy1Dvlc.png",
              title: "MI PRIMER PORTFOLIO",
              text: "Desarrollado en React.js este fue mi primer portafolio donde el usuario podía leer sobre mí, ponerse en contacto, y también ver mis proyectos en un slider.\nIntenté conseguir una estética seria y formal, además de que era la primera vez que utilizaba Figma para hacer un diseño general del sitio web antes de empezar a codificarlo.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/hU9YLxz.png",
              title: "SLIDER DE PROYECTOS",
              text: "Con una librería hice un slider para que el usuario pueda ver todos mis proyectos relevantes en ese momento. Por otro lado las imágenes que se ven en el slider están hechas con Figma.\nCada proyecto tiene un simple efecto en hover que le permite al usuario ver el nombre del proyecto, asi como también dos botones, uno para ir a la demo del proyecto y el otro para ver el código de este.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/10gIWMy.png",
              title: "FORMULARIO DE CONTACTO",
              text: "Usando EmailJS cree un formulario de contacto que permite al usuario que vea mi portfolio enviarme un mensaje a mi email desde allí.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/p5or2HJ.png",
              title: "AJUSTES",
              text: "Por último, el usuario también tiene la posibilidad de elegir entre un tema claro y uno oscuro. Así como su preferencia de idioma entre inglés y español.",
            },
            {
              project:
                "https://franco-espinosa-portafolio-antiguo.netlify.app/",
            },
          ],
          en: [
            {
              banner: "https://i.imgur.com/Gf6BXsk.png",
              title: "PORTFOLIO - V.1",
            },
            {
              side: "left",
              img: "https://i.imgur.com/0eqr7oG.png",
              title: "MY FIRST PORTFOLIO",
              text: "Developed in React.js this was my first portfolio where the user could read about me, get in touch, and also see my projects in a slider.\nI tried to achieve a serious and formal aesthetic, as well as this was the first time I used Figma to do a general design of the website before starting to code it.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/9SwrDGQ.png",
              title: "PROJECTS SLIDER",
              text: "With a library I made a slider so that the user can see all my relevant projects at that time. On the other hand the images you see in the slider are made with Figma.\nEach project has a simple hover effect that allows the user to see the project name, as well as two buttons, one to go to the project demo and the other to see the project code.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/8M4SYAz.png",
              title: "CONTACT FORM",
              text: "Using EmailJS I created a contact form that allows the user who sees my portfolio to send me a message to my email from there.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/sxHn5iO.png",
              title: "SETTINGS",
              text: "Finally, the user also has the possibility to choose between a light and dark theme. As well as his language preference between English and Spanish.",
            },
            {
              project:
                "https://franco-espinosa-portafolio-antiguo.netlify.app/",
    ...
    projects: [
      {
        title: "CSS Gallery",
        first_text_en:
          "I developed this website in React.js so I could store some small CSS projects here.",
        second_text_en:
          "But in the end it became my first encounter with LocalStorage, which gave me the opportunity to save both color and language preferences of the user in the browser.",
        first_text_es:
          "Desarrollé este sitio web en React.js para poder almacenar aquí algunos pequeños proyectos CSS.",
        second_text_es:
          "Pero al final se convirtió en mi primer encuentro con LocalStorage, que me dio la oportunidad de guardar tanto las preferencias de color como de idioma del usuario en el navegador.",
        ...
        extra_data: {
          es: [
            {
              banner: "https://i.imgur.com/IPBKNV3.png",
              title: "CSS GALLERY",
            },
            {
              side: "left",
              img: "https://i.imgur.com/1KVr8ZE.png",
              title: "FUNCIONALIDAD",
              text: "Desarrollé este sitio web en React.js para poder almacenar aquí algunos pequeños proyectos CSS.\nPero al final se convirtió en mi primer encuentro con LocalStorage, que me dio la oportunidad de guardar tanto las preferencias de color como de idioma del usuario en el navegador.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/CpH80LR.png",
              title: "MODIFICAR COLOR E IDIOMA",
              text: "Usando react states y LocalStorage, en esta web el usuario puede elegir entre 4 colores (azul, rojo, amarillo y verde) que cambian a lo largo de la web.\nAdemás, el usuario podrá cambiar el idioma entre inglés y español.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/oEtfiEc.png",
              title: "LA GALERÍA",
              text: "En la galería el usuario podrá ver una cuadrícula con todos los pequeños efectos CSS, y hacer clic para ir a verlos en acción. Una vez allí, podrá volver a la galería pulsando un botón de retorno en la esquina superior izquierda de la pantalla.",
            },
            {
              project: "https://goorezy-css-gallery.netlify.app/",
            },
          ],
          en: [
            {
              banner: "https://i.imgur.com/cygVBpl.png",
              title: "CSS GALLERY",
            },
            {
              side: "left",
              img: "https://i.imgur.com/jZs5sBI.png",
              title: "FUNCTIONALITY",
              text: "I developed this website in React.js so I could store some small CSS projects here.\nBut in the end it became my first encounter with LocalStorage, which gave me the opportunity to save both color and language preferences of the user in the browser.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/b8MrMRW.png",
              title: "MODIFY COLOR AND LANGUAGE",
              text: "Using react states and LocalStorage, on this website the user can choose between 4 colors (blue, red, yellow and green) which change throughout the website.\nAs well as the user will be able to change the language between English and Spanish.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/LuT9F9u.png",
              title: "THE GALLERY",
              text: "In the gallery the user will be able to see a grid with all the little CSS effects, and click to go to see them in action. Once there you can return to the gallery by clicking a return button in the upper left corner of the screen.",
            },
            {
              project: "https://goorezy-css-gallery.netlify.app/",
            },
      ...
      },
      {
        title: "Hattyng",
        first_text_en:
          "My mentor at the time, Marcos Espinosa, gave me and a colleague a challenge. To develop as a team two applications in one months. This was the second one we developed.",
        second_text_en:
          "The first complex project with a wide range of functionalities that I worked on.",
        first_text_es:
          "Mi mentor por aquel entonces, Marcos Espinosa, nos propuso un reto a mí y a un colega. Desarrollar en equipo dos aplicaciones en un mes. Esta fue la segunda que desarrollamos.",
        second_text_es:
          "El primer proyecto complejo con una amplia gama de funcionalidades en el que trabajé.",
        ...
        extra_data: {
          es: [
            {
              banner: "https://i.imgur.com/3dmX3QP.png",
              title: "HATTYNG",
            },
            {
              side: "left",
              img: "https://i.imgur.com/dr3tLfY.png",
              title: "FINALIDAD DE LA APLICACIÓN",
              text: "Mi mentor por aquel entonces, Marcos Espinosa, nos propuso un reto a mí y a un colega. Desarrollar en equipo dos aplicaciones en un mes. Esta fue la segunda que desarrollamos.\nEl primer proyecto complejo con una amplia gama de funcionalidades en el que trabajé.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/wSsLhSP.png",
              title: "AUTENTICACIÓN DE USUARIOS",
              text: "Esta aplicación permite al usuario crear una cuenta, y personalizar su perfil, donde debe introducir su nombre, edad, una breve descripción, nacionalidad y también seleccionar una foto de perfil.\nCon esta cuenta, el usuario puede iniciar sesión en la aplicación.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/etlsdgE.png",
              title: "TU PERFIL",
              text: "El usuario podrá ver su perfil, desde ahí podrá ver su información, y buscar a otros usuarios por su nombre. Estos usuarios pueden ser añadidos como amigos, y si están conectados, podrán ver si están conectados, y si lo están, en qué sala de chat se encuentran.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/I8eI0D1.png",
              title: "AJUSTES",
              text: "En la pestaña de configuración el usuario podrá modificar toda su información existente, así como eliminar su cuenta por completo.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/rCoqYQV.png",
              title: "AMIGOS",
              text: "En la pestaña de amigos el usuario podrá ver a sus amigos, ver si están conectados o no, y si están conectados, podrá ver en qué sala de chat están.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/rBjkj5k.png",
              title: "SALAS DE CHAT",
              text: "Aquí reside la principal funcionalidad de la aplicación, dos salas de chat a las que los usuarios pueden unirse y chatear entre ellos. En estas salas puedes ver todos los usuarios que están en ella.",
            },
            {
              project: "https://hattyng.netlify.app/login",
            },
          ],
          en: [
            {
            ...
            },
            {
              ...
              text: "My mentor at the time, Marcos Espinosa, gave me and a colleague a challenge. To develop as a team two applications in one months. This was the second one we developed.\nThe first complex project with a wide range of functionalities that I worked on.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/wSsLhSP.png",
              title: "USER AUTHENTICATION",
              text: "This application allows the user to create an account, and customize his profile, where he must enter his name, age, a brief description, nationality and also select a profile picture.\nWith this account the user can then log in to the application.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/etlsdgE.png",
              title: "YOUR PROFILE",
              text: "The user will be able to see his profile, from there he will be able to see his information, and search for other users by name. These users can be added as friends, and if they are online, they can see if they are connected, and if they are, in which chat room they are in.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/I8eI0D1.png",
              title: "SETTINGS",
              text: "In the settings tab the user will be able to modify all his existing information, as well as delete his account completely.",
            },
            {
              side: "left",
              img: "https://i.imgur.com/rCoqYQV.png",
              title: "FRIENDS",
              text: "In the friends tab the user will be able to see his friends, see if they are online or not, and if they are online, he will be able to see in which chat room they are.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/rBjkj5k.png",
              title: "CHAT ROOMS",
              text: "Here lies the main functionality of the application, two chat rooms that users can join and chat with each other. In these rooms you can see all the users that are in it.",
            },
            {
              project: "https://hattyng.netlify.app/login",
            },
      ...
      },
      {
        ...
        first_text_en:
          "My mentor at the time, Marcos Espinosa, gave me and a colleague a challenge. To develop as a team two applications in one months. This was the first one we developed.",
        second_text_en:
          "A website to store and display CSS effects, but, before going into the CSS effects my colleague created a small 3D experience.",
        first_text_es:
          "Mi mentor por aquel entonces, Marcos Espinosa, nos propuso un reto a mí y a un colega. Desarrollar en equipo dos aplicaciones en un meses. Esta fue la primera que desarrollamos.",
        second_text_es:
          "Un sitio web para almacenar y mostrar efectos CSS, pero, antes de entrar en los efectos CSS mi colega creó una pequeña experiencia 3D.",
        ...
        extra_data: {
          es: [
            {
              banner: "https://i.imgur.com/omepLZG.png",
              title: "VIRTUAL GALLERY",
            },
            {
              side: "left",
              img: "https://i.imgur.com/dwPvq2e.png",
              title: "FINALIDAD DEL SITIO WEB",
              text: "Mi mentor por aquel entonces, Marcos Espinosa, nos propuso un reto a mí y a un colega. Desarrollar en equipo dos aplicaciones en un meses. Esta fue la primera que desarrollamos.\nUn sitio web para almacenar y mostrar efectos CSS, pero, antes de entrar en los efectos CSS mi colega creó una pequeña experiencia 3D.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/OZqj8k8.png",
              title: "LA GALERÍA",
              text: "Una vez dentro de la galería puedes ver proyectos CSS, los cuales poseen una pequeña descripcion, un listado de con que tecnología fueron hechos, y por último un enlace al perfil de GitHub de quien lo creo.",
            },
            {
              project: "https://arg-virtual-gallery.netlify.app/",
            },
          ],
          en: [
            {
            ...
            },
            {
              ...
              img: "https://i.imgur.com/dwPvq2e.png",
              title: "PURPOSE OF THE WEBSITE",
              text: "My mentor at the time, Marcos Espinosa, gave me and a colleague a challenge. To develop as a team two applications in one months. This was the first one we developed.\nA website to store and display CSS effects, but, before going into the CSS effects my colleague created a small 3D experience.",
            },
            {
              side: "right",
              img: "https://i.imgur.com/OZqj8k8.png",
              title: "THE GALLERY",
              text: "Once inside the gallery you can see CSS projects, which have a short description, a list of what technology they were made with, and finally a link to the GitHub profile of who created it.",
            },
            {
              project: "https://arg-virtual-gallery.netlify.app/",
            },
